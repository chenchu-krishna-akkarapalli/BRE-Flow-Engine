---
name: code-review
description: Review changed code for correctness, SLA compliance, anti-hardcoding enforcement, O(1) data structure efficiency, and memory lifecycle safety.
---
...
Execute `./review.sh` from this directory to trigger mechanical syntax, build, and test runners.
