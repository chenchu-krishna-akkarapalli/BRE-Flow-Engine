...
3. **Daily Log Close-out**: Append a close-out entry to `memory/runtime/dailylog.md`: what changed, how it was verified, measured latency numbers, and what remains outstanding.
