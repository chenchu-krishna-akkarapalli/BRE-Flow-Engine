...
router.include_router(navigation.router, prefix="/navigation", tags=["Dynamic Navigation & Modules"])
router.include_router(roles.router, prefix="/roles", tags=["Role Hierarchy & Governance"])
